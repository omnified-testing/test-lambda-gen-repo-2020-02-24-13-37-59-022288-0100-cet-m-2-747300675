The go.mod file in the root folder indicates that this is a "Go Module".
	...
	The go.mod file specifes the module name, which in this case is: github.com/omnified-testing/test-lambda-gen-repo-2020-02-24-13-37-59-022288-0100-cet-m-2-747300675.
